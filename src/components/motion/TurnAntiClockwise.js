...
// const TurnAntiClockWise = ({ comp_id, spriteId }) => {
//   const [angle, setAngle] = useState(0);
...
//       : 0;
//     el.style.transform = `rotate(${currentRotation + anti_angle}deg)`;
//   };
...
const TurnAntiClockWise = ({ comp_id, spriteId }) => {
  ...
  const handleClick = () => {
    ...
    console.log("TurnAntiClockWise block spriteId:", realSpriteId);
      ...
      <div className="text-center rounded bg-blue-500 p-2 my-3">
        <div className="grid grid-cols-2">
          ...
          <input
            ...
            onClick={e => e.stopPropagation()} // Prevents accidental run on input click
          />
        </div>
        <div
          id={comp_id}
