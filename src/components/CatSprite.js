          ...
          <g id="Page-1" stroke="none" fillRule="evenodd">
            <g id="costume1">
              <g id="costume1.1">
                ...
                <g id="head">
                  <path
                    d="M 53.1 9 C 50.8 8.6 48.4 8.4 45.6 8.6 C 40.9 8.8 36.4 10.5 36.4 10.5 L 24.3 2.6 C 23.9 2.4 23.4 2.7 23.5 3.1 L 25.6 21 C 26.2 20.2 15 33.8 22.1 45.2 C 29.2 56.6 44.3 61.7 63.1 58 C 81.9 54.3 86.3 43.5 85.1 37.8 C 83.9 32.1 76.8 30 76.8 30 C 76.8 30 79.2 25.8 79.2 19.8 C 79.2 13.8 73.5 9.4 70 8.3 C 65.7 6.9 60.5 9.6 60.5 9.6 C 60.5 9.6 56.1 10 53.1 9 Z "
                    id="head-shape"
                    stroke="#001026"
                    strokeWidth="1.2"
                    fill="#FFAB19"
                  ...
                  />
                  <path
                    d="M 33.3 21.1 C 33.3 21.1 35.7 26.2 36.9 27.3 C 37.2 27.6 37.4 28 37.5 28.3 C 37.8 29 37.5 29.8 36.9 30.2 C 36.1 30.8 34.7 31.6 34 32.2 C 33.2 32.8 33.3 33.9 34.6 34.7 C 35.6 35.3 37.4 34.4 38.6 33.6 C 41.3 31.4 43.6 27.7 44 26.7 C 44.2 26.2 44.2 25.6 44 25.2 C 43.6 24.2 41.7 22.4 39.8 22.6 C 37.8 22.8 35.6 22.2 33.3 21.1 Z "
                    id="mouth"
                    stroke="#001026"
                    strokeWidth="0.6"
                    fill="#001026"
                  ...
                  />
                  <path
                    d="M 63.5 18.7 C 65.5 16.5 68.2 18.8 67.5 20.9 C 67.3 21.5 67.5 22.1 67.9 22.6 C 68.2 23 68.7 23.2 69.3 23.2 C 69.9 23.2 70.5 22.9 70.8 22.4 C 71.5 21.2 71.4 18.9 67.3 18.5 C 66.5 18.5 64.3 18.3 63.5 18.7 Z "
                    id="nose"
                    stroke="#001026"
                    strokeWidth="0.6"
                    fill="#001026"
                ...
                <path
                  d="M 52.3 20.6 C 52.3 20.6 57.1 20.9 58.4 22.7 C 59.7 24.4 60.4 27.3 60.4 27.3"
                  id="whisker"
                  stroke="#001026"
                  strokeWidth="0.9"
                  strokeLinecap="round"
                />
                <path
                  d="M 49.9 24.7 C 49.9 24.7 54.3 24.6 55.5 26.6"
                  id="whisker"
                  stroke="#001026"
                  strokeWidth="0.9"
                  strokeLinecap="round"
                />
                <path
                  d="M 47.2 28.5 C 47.2 28.5 50.2 27.9 50.8 29.8"
                  id="whisker"
                  stroke="#001026"
                  strokeWidth="0.9"
                  strokeLinecap="round"
                />
                <path
                  d="M 55.2 18.7 C 55.2 18.7 59.4 19.5 60.5 20.8"
                  id="whisker"
                  stroke="#001026"
                  strokeWidth="0.9"
                  strokeLinecap="round"
                />
                <path
                  d="M 58.8 21.7 C 58.8 21.7 63.6 22.3 65.1 23.9"
                  id="whisker"
                  stroke="#001026"
                  strokeWidth="0.9"
                  strokeLinecap="round"
